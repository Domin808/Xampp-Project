<?php
	...
	if (isset($_POST['email']))
	{
        ...
        $sekret = "6LcZol8rAAAAAHwDLzdiZ6_7Gm0Ozm2yfNg0_es8";
        $recaptchaToken = $_POST['recaptcha_token'];

        $sprawdz = file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret=' . $sekret . '&response=' . $recaptchaToken);
        $odpowiedz = json_decode($sprawdz);

        if (!($odpowiedz->success && $odpowiedz->score >= 0.5 && $odpowiedz->action == 'register')) {
            $wszystko_OK = false;
            $_SESSION['e_bot'] = "Wykryto podejrzane działanie – rejestracja zablokowana.";
        }
